...
3. [In-depth about digital certificates](#third-example)
4. [Why do we need a PKI (Public Key Infrastructure) ?](#fourth-examplehttpwwwfourthexamplecom)
5. [OpenSSL configuration important parts](#fourth-examplehttpwwwfourthexamplecom)
6. [Creating a two-tier PKI with CA and Intermediate CA](#fourth-examplehttpwwwfourthexamplecom)
...
---
## 3. In-depth about digital certificates
...
---
## 4. Why do we need a PKI (Public Key Infrastructure) ?
...
---
## 5. OpenSSL configuration important parts
...
## 6. Creating a two-tier PKI with CA and Intermediate CA
